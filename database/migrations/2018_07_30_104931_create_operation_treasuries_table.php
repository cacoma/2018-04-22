...
class CreateOperationTreasuriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('operation_treasuries', function (Blueprint $table) {
            $table->increments('id');
      ...
      Schema::table('operation_treasuries', function($table) {
            //foreign keys
            ...
            $table->softDeletes();
            DB::statement('ALTER TABLE operation_treasuries ADD total_operation DECIMAL(18,2) AS (price_operation * quant_operation - broker_fee_operation)');
            ...
            DB::statement('ALTER TABLE operation_treasuries ADD duration_days int(18) AS (TIMESTAMPDIFF(day, date_invest,date_operation))');
        });
    }
    ...
    {
        Schema::dropIfExists('operation_treasuries');
    }
}
